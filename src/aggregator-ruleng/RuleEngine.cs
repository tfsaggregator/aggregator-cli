...
namespace aggregator.Engine
{
    ...
    public class RuleEngine
    {
        ...
        public async Task<string> ExecuteAsync(string projectName, int workItemId, WorkItemTrackingHttpClient witClient, CancellationToken cancellationToken)
        {
            ...
            var context = new EngineContext(witClient, projectName, logger);
